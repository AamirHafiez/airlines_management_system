...
Public Class ExporterForm
    ...
    Public Function Clearing_Textboxes()
        ...
        TextBox_ExpContact.Clear()
        TextBox_ExpID.Clear()
        TextBox_ExpAdd.Clear()
        TextBox_ImpID.Clear()
    ...
    Private Sub IMPORTANDPRODUCTToolStripMenuItem_Click(sender As Object, e As EventArgs)
    ...
    Public Function LoadsTable()
        ...
        Try
            MysqlConn.Open()
            Dim Query As String
            Query = "select * from importexport.exporter"
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        ...
        Try
            ...
            MysqlConn.Open()
            Query1 = "INSERT INTO importexport.exporter (imp_id, exp_id, prod_id, prod_name, prod_quant, exp_add, charges, arrival, departure, exp_contact) VALUES ('" & TextBox_ImpID.Text & "', '" & TextBox_ExpID.Text & "', '" & TextBox_ProdID.Text & "', '" & TextBox_ProdName.Text & "', '" & TextBox_ProdQuant.Text & "', '" & TextBox_ExpAdd.Text & "', '" & TextBox_Charges.Text & "', '" & DateTimePicker_Arrival.Text & "', '" & DateTimePicker_Departure.Text & "', '" & TextBox_ExpContact.Text & "');"
            COMMAND = New MySqlCommand(Query1, MysqlConn)
            READER = COMMAND.ExecuteReader
            MysqlConn.Close()

            MysqlConn.Open()
            Query2 = "INSERT INTO importexport.importer (exp_id, imp_id, prod_id, prod_name, prod_quant, charges, arrival, departure) VALUES ('" & TextBox_ExpID.Text & "', '" & TextBox_ImpID.Text & "', '" & TextBox_ProdID.Text & "', '" & TextBox_ProdName.Text & "', '" & TextBox_ProdQuant.Text & "', '" & TextBox_Charges.Text & "', '" & DateTimePicker_Arrival.Text & "', '" & DateTimePicker_Departure.Text & "');"
            COMMAND = New MySqlCommand(Query2, MysqlConn)
            READER = COMMAND.ExecuteReader
            MysqlConn.Close()
    ...
    Private Sub Button_Update_Click(sender As Object, e As EventArgs) Handles Button_Update.Click
        ...
        Try
            ...
            MysqlConn.Open()
            Query1 = " update importexport.exporter set imp_id = '" & TextBox_ImpID.Text & "', exp_id = '" & TextBox_ExpID.Text & "', prod_name = '" & TextBox_ProdName.Text & "', prod_quant = '" & TextBox_ProdQuant.Text & "', exp_add = '" & TextBox_ExpAdd.Text & "', charges = '" & TextBox_Charges.Text & "', arrival = '" & DateTimePicker_Arrival.Text & "', departure = '" & DateTimePicker_Departure.Text & "', exp_contact = '" & TextBox_ExpContact.Text & "' where prod_id = '" & TextBox_ProdID.Text & "';"
            COMMAND = New MySqlCommand(Query1, MysqlConn)
            READER = COMMAND.ExecuteReader
            MysqlConn.Close()

            MysqlConn.Open()
            Query2 = " update importexport.importer set imp_id = '" & TextBox_ImpID.Text & "', exp_id = '" & TextBox_ExpID.Text & "', prod_name = '" & TextBox_ProdName.Text & "', prod_quant = '" & TextBox_ProdQuant.Text & "', charges = '" & TextBox_Charges.Text & "', arrival = '" & DateTimePicker_Arrival.Text & "', departure = '" & DateTimePicker_Departure.Text & "' where prod_id = '" & TextBox_ProdID.Text & "';"
            COMMAND = New MySqlCommand(Query2, MysqlConn)
            READER = COMMAND.ExecuteReader
            MysqlConn.Close()
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        Try
            If e.RowIndex >= 0 Then
                ...
                TextBox_ExpAdd.Text = row.Cells("exp_add").Value.ToString
                TextBox_Charges.Text = row.Cells("charges").Value.ToString
                TextBox_ExpContact.Text = row.Cells("exp_contact").Value.ToString
    ...
    Private Sub EXPORTANDPRODUCTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EXPORTANDPRODUCTToolStripMenuItem.Click
        MysqlConn = New MySqlConnection
        MysqlConn.ConnectionString = "server=localhost;userid=root;password=aamir786;database=importexport"
        ...
        Try
            MysqlConn.Open()
            Dim Query As String
            Query = "select exporter.exp_id ,prod.prod_id, prod.prod_name, exporter.charges from importexport.exporter right join importexport.prod on exporter.prod_id = prod.prod_id order by exporter.exp_id;"
            COMMAND = New MySqlCommand(Query, MysqlConn)
            SDA.SelectCommand = COMMAND
            SDA.Fill(dbDataSet)
            bSource.DataSource = dbDataSet
